...
use crate::{
    resources::components::SsramBits, Bsram1R1Rw1024, HardwareIdentity, Module, ModuleIo,
    TargetResourceRequest, VerilogDependency, VerilogIdentity, ZeroBsramImage,
};
...
mod tests {
    ...
    fn verify_verilog_with_iverilog() {
        crate::verify_verilog_with_iverilog::<G16DirectMappedCache>().unwrap();
    }
}
