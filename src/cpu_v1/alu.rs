...
impl CpuComponent for CpuAlu {
    ...
    fn build(input: &Self::Input) -> Self::Output {
        ...
        let alu0_zero = Wires::parse_u8(0) & alu0_select[Alu0Select::Zero as usize].expand();
        ...
        let alu1_neg_one = Wires::parse_u8(15) & alu1_select[Alu1Select::NegOne as usize].expand();
        let alu1_zero = Wires::parse_u8(0) & alu1_select[Alu1Select::Zero as usize].expand();
        let alu1_one = Wires::parse_u8(1) & alu1_select[Alu1Select::One as usize].expand();
