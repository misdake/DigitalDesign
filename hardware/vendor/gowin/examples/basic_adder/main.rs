use digital_design_circuit::{add_naive, input_w_const, mux2_w, reg_w, CircuitWires, Wire, Wires};
...
mod tests {
    use super::*;
    use digital_design_hardware_gowin::{ResourceKind, TangNano20KInputsValue};
    use std::path::Path;
