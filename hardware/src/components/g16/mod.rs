...
mod tests {
    ...
    use cpu_v2::g16::{
        self, AluOp, BranchCondition, ImmediateOp, Machine, RunOutcome, SpecialRegister,
    };
    use cpu_v2::{frontend::compile_program, Compiler, CompilerOptions};
    ...
    fn verify_verilog_with_iverilog() {
        crate::verify_verilog_with_iverilog::<G16Core>().unwrap();
    }
}
