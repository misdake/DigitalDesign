...
#[derive(Template)]
#[template(path = "primitives/spi_flash/spi_flash_reader.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/spi_flash/spi_flash_reader_tb.v", escape = "none")]
...
mod tests {
    ...
    use digital_design_circuit::build_circuit;
