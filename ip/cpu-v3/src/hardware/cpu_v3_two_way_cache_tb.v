...
reg [63:0] last_write_data = 0;

wire [3:0] beat_index = 4'd4 - beats_remaining;
...
always @(posedge clk) begin
    ...
    if (beats_remaining != 0) begin
        ...
        memory_read_data <= {word_pattern(line_base_r[11:0] + 4 * beat_index + 3),
                             word_pattern(line_base_r[11:0] + 4 * beat_index + 2),
                             word_pattern(line_base_r[11:0] + 4 * beat_index + 1),
                             word_pattern(line_base_r[11:0] + 4 * beat_index)};
