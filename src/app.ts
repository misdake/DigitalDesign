...
render(html`
    <div id="content">
        <gamecomp-element .gameComp=${gameComp1} style="position: absolute; left: 100px;"></gamecomp-element>
        <gamecomp-element .gameComp=${gameComp2} style="position: absolute; left: 500px;"></gamecomp-element>
    </div>
`, document.body);