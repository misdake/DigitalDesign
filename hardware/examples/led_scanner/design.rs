use digital_design_code::{input_const, mux2, mux2_w, reg, reg_w, CircuitWires, Wire, Wires};
use digital_design_hardware::{
    ClockDivider, ClockDividerInput, ClockDividerOutput, ClockDividerState, GowinModuleProject,
    Hardware, Module, ModuleIo, TangNano20K, TangNano20KInputs, TangNano20KOutputs,
