...
#[derive(Template)]
#[template(path = "primitives/bsram/1rw_1024.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/bsram/1r1rw_1024.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/bsram/true_dual_port_1024.v", escape = "none")]
