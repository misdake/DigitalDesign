...
SDRAM_Controller_HS_QN88 u_sdram_controller (
    ...
    .I_sdrc_rst_n(sdram_reset_sync[1]),
    .I_sdrc_clk(logic_clk),
    .I_sdram_clk(sdram_clk_180),
    .I_sdrc_cmd_en(sdram_command_valid),
    .I_sdrc_cmd(sdram_command),
    .I_sdrc_precharge_ctrl(sdram_precharge),
    .I_sdram_power_down(1'b0),
    .I_sdram_selfrefresh(1'b0),
    .I_sdrc_addr(sdram_address),
    .I_sdrc_dqm(sdram_write_mask),
    .I_sdrc_data(sdram_write_data),
    .I_sdrc_data_len(sdram_burst_length),
    .O_sdrc_data(sdram_read_data),
    .O_sdrc_init_done(sdram_init_done),
    .O_sdrc_cmd_ack(sdram_command_ack)
);
