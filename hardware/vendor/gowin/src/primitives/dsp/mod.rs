...
use askama::Template;
use digital_design_circuit::{CircuitWires, Wires};
...
#[derive(Template)]
#[template(path = "primitives/dsp/mul_s18.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/dsp/mul_add_s18.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/dsp/mac_s18.v", escape = "none")]
...
pub struct DspMacS18Input {
    pub reset_n: digital_design_circuit::Wire,
    pub a: Wires<INPUT_WIDTH>,
    pub b: Wires<INPUT_WIDTH>,
}
...
#[derive(Template)]
#[template(path = "primitives/dsp/mul_sum_s18.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/dsp/mul_difference_s18.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/dsp/pre_add_mul_s18.v", escape = "none")]
...
#[derive(Template)]
#[template(path = "primitives/dsp/pre_sub_mul_s18.v", escape = "none")]
