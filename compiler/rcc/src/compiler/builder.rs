...
impl FuncBuilder {
    ...
    pub fn cmp(&self, lhs: VReg, rhs: CmpRhs, cond: CompareOp) -> Cmp {
        Cmp {
            lhs,
            rhs,
            cond,
    ...
    pub fn cmp_signed(&self, lhs: VReg, rhs: CmpRhs, cond: CompareOp) -> Cmp {
        Cmp {
            lhs,
            rhs,
            cond,
...
";
    ...
    fn test_build_if_else_phi() {
        ...
        b.set(x, ten);
        let c0 = b.get(c);
        let cmp = b.cmp(c0, CmpRhs::Imm(0), CompareOp::NotEqual);
        b.if_else(
            cmp,
            |b| {
...
";
    ...
    fn test_build_while_loop_phi() {
        ...
        b.while_loop(
            |b| {
                let i = b.get(i);
                let n = b.get(n);
                b.cmp(i, CmpRhs::Reg(n), CompareOp::LessEqual)
            },
            |b| {
                let s = b.get(sum);
                let i0 = b.get(i);
    ...
    fn test_build_break_continue() {
        ...
        b.while_loop(
            |b| {
                let i = b.get(i);
                b.cmp(i, CmpRhs::Imm(10), CompareOp::Less)
            },
            |b| {
                let i0 = b.get(i);
                let one = b.load_imm(1);
                ...
                // if (i == 3) continue;
                let i1c = b.get(i);
                let cmp = b.cmp(i1c, CmpRhs::Imm(3), CompareOp::Equal);
                b.if_then(cmp, |b| b.continue_());
                // if (i == 8) break;
                let i1b = b.get(i);
                let cmp = b.cmp(i1b, CmpRhs::Imm(8), CompareOp::Equal);
