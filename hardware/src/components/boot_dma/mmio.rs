...
mod tests {
    ...
    fn numeric_channels_match_the_compiler_boot_abi() {
        assert_eq!(DMA_DEVICE, cpu_v2::g16::boot::BOOT_DMA_DEVICE);
        assert_eq!(1, cpu_v2::g16::boot::DMA_STATUS);
        assert_eq!(14, cpu_v2::g16::boot::DMA_ERROR);
        assert_eq!(15, cpu_v2::g16::boot::DMA_COMPLETED_WORDS_LOW);
